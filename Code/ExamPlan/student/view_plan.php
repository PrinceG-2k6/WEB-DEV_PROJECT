...
<body>
    ...
    <div class="back">
        ...
        <div class="Goback"><a href="/Code/ExamPlan/student/index.php"><i class="fa-solid fa-right-from-bracket"></i> Go Back</a></div>
    </div>
    <div class="view_plan">
        ...
        <div class="show_plan">
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['view_plan'])) {
                ...
                $stmt0 = $conn->prepare("SELECT * FROM seating_plans_left 
                ...
                if(!$results0)
                {
                    $stmt0 = $conn->prepare("SELECT * FROM seating_plans_right 
            ...
            ?>
                ...
                if(isset($_POST['view_plan']))
                {
                    try{
                        ...
                        echo "<table border='2' cellspacing='0' align='center' style='overflow-x:auto;'>";
